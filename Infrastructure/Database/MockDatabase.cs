...
namespace Infrastructure.Database
{
    public class MockDatabase
    {
        ...
        {
            new UserModel { UserId = Guid.NewGuid(), UserName = "JohnCorleone", UserPassword = "killYou" },
            new UserModel { UserId = Guid.NewGuid(), UserName = "JaneCorleone", UserPassword = "killYou2" },
